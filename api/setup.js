...
export default async function handler(req, res) {
  ...
  try {
    ...
    await sql`CREATE INDEX IF NOT EXISTS idx_attendance_employee_date ON attendance(employee_id, registered_at)`;
    ...
    return res.json({ ok: true, message: 'Base de datos lista. Admin 9999, demo 1234/5678.' });
  } catch (e) {
    console.error(e);
